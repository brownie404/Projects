...
//main draw function//
void paint(int printx,int printy){
	iSetColor(rcol,gcol,bcol);
	iFilledCircle(printx,printy,w,200);	
}
...
/*void start(){
	iFilledCircle(posx,posy,100,1000);
	}*/
...
void iDraw() {
	...
	/*if(posx<1400){
	iFilledCircle(posx,posy,200,1000);
	posx+=5;
	}
	...
	iFilledRectangle(0,0,1500,1035);*/
	...
	/*ERASER TOOL*/
	iSetColor(255,255,255);
	iRectangle(1000, 940, 80, 40);/*eraser*/
	iRectangle(1150, 940, 80, 40);/*erase all*/
	
	iSetColor(0,0,0);
	iFilledRectangle(1000, 945, 70, 30);
	...
	iText(1005, 910, "ERASER", GLUT_BITMAP_HELVETICA_18);
	iText(1145, 910, "ERASE ALL", GLUT_BITMAP_HELVETICA_18);
	...
	/*iText(240, 790, "STROKE WIDTH", GLUT_BITMAP_HELVETICA_18);*/
	iSetColor(255,255,255);
	iText(510, 790, "SHAPES", GLUT_BITMAP_HELVETICA_18);
...
void iMouse(int button, int state, int mx2, int my2){
	...
	clicky=my2;
		...
		if(my2>900&&my2<980&&mx2>250&&mx2<950||my2>945&&my2<975&&mx2>100&&mx2<1070){
	getx=mx2;
	gety=my2;
	pointerx=1500;
	pointery=1035;/*Color and eraser*/
	tool=0;
	}

	else if(my2>820&&my2<880&&mx2>225&&mx2<267){w=5;pointerx=1500;pointery=1035;tool=0;}/*Stroke width*/

	else if(my2>820&&my2<880&&mx2>267&&mx2<327){w=10;pointerx=1500;pointery=1035;tool=0;}/*Stroke width*/

	else if(my2>820&&my2<880&&mx2>327&&mx2<400){w=20;pointerx=1500;pointery=1035;tool=0;}/*Stroke width*/
	
	/*TOOL SELECTOR*/
	else if(my2>820&&my2<880&&mx2>440&&mx2<540){tool=1;clickx=2000;clicky=2000;}

	else if(my2>820&&my2<880&&mx2>560&&mx2<660){tool=2;clickx=2000;clicky=2000;}

	else if(my2>940&&my2<980&&mx2>1150&&mx2<1230){tool=3;}

	/*TOOL TYPE SELECTION*/
	if(my2>775&&my2<875&&mx2>700&&mx2<900){tltp=0;clickx=2000;clicky=2000;}

	else if(my2>775&&my2<875&&mx2>900&&mx2<1100){tltp=1;clickx=2000;clicky=2000;}

	else if(my2>775&&my2<875&&mx2>1100&&mx2<1300){tltp=2;clickx=2000;clicky=2000;}
